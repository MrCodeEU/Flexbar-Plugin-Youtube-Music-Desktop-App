    ...
    <v-row>
      <v-col cols="12">
        <v-card elevation="2" class="rounded-lg">
          <v-card-item>
            <v-card-title class="text-h6 font-weight-regular">Seek Backward Settings</v-card-title>
            <v-card-subtitle>Configure seek backward amount and appearance</v-card-subtitle>
          </v-card-item>
          <v-card-text class="pt-0">
              ...
              <v-col cols="12">
                ...
                >
                  <template v-slot:prepend>
                    <v-icon color="orange">mdi-rewind</v-icon>
                  </template>
            ...
            >
              <div class="text-body-2">
                ...
                • Click the button to skip backward by the configured amount<br>
            ...
            >
              ...
              <div class="text-body-2">
                <v-icon color="orange" size="small">mdi-rewind</v-icon>
                Skip backward {{ modelValue.data.seconds }} second{{ modelValue.data.seconds !== 1 ? 's' : '' }}
              </div>
