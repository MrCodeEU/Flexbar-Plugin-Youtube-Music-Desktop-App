    ...
    <v-row>
      <v-col cols="12">
        <v-card elevation="2" class="rounded-lg">
          <v-card-item>
            <v-card-title class="text-h6 font-weight-regular">Dislike Button Settings</v-card-title>
            <v-card-subtitle>Customize appearance and behavior</v-card-subtitle>
          </v-card-item>
          <v-card-text class="pt-0">
            <v-row dense>
              <!-- Disliked Color Picker -->
              <v-col cols="12" sm="6">
            ...
            >
              <div class="text-body-2">
                <strong>Note:</strong> YouTube Music uses a three-state system: Dislike, Dislike, and Indifferent. This button toggles between Dislike and Indifferent states.
              </div>
            </v-alert>
          </v-card-text>
        </v-card>
...
export default {
  name: 'YouTubeMusicDislikeButton',
  props: {
    modelValue: {
      type: Object,
      required: true
